...
class ComplexNumberTestSuite : public CxxTest::TestSuite{
    public:
        void TestDefaultConstructor(void){
            //Test default constructor set complex number to zero
            ComplexNumber z;
        ...
        void TestCustomisedConstructor(void){
            //Use constructor that allows us to specify real and imaginary
        ...
        void TestCalculatePower(void){
            //Specifu a comlpex number, z, and calculate the modulus and 
            //argument
            double real = 4.0;
            double imaginary = -3.0;
            ComplexNumber z(real, imaginary);
            ...
            //Calculate z*z and calculate the modulus and argument of 
            //z*z
            ...
            //Test that:
            //modulus of z*z = (modulus of z)* (modulus od z)
        ...
        void TestAgainstStdLibrary(){
            ...
            TS_ASSERT_DELTA(z.CalculateModulus(), abs(std_z), 1.0e-8);
            ...
            TS_ASSERT_DELTA(z_5.CalculateModulus(), abs(std_z), 1e-8);
        }
